...
_device_number = ctypes.c_long(ALP_DEFAULT)
...
class AlpApi(object):
    ...
    def __getattribute__(self, name):
        ...
        if name in function_names:
            attribute = getattr(self.dll, name)
...
class Api(AlpApi):
    ...
    def __init__(self, path):
        ...
        self.device_id = ctypes.c_ulong(ALP_DEFAULT)
        # self.current_device_id = ALP_DEFAULT
        self.dmd_type = ctypes.c_long(ALP_DEFAULT)
        # TODO swap following lines...
        self.sequence_id = ALP_DEFAULT
        # self.current_sequence_id = ALP_DEFAULT
    ...
    # def display_white_sequence(self, seq_repeat=ALP_DEFAULT):
    #     '''TODO complete...'''
    #     DeviceId = self.device_id
    #     # Allocate sequence
    #     bit_planes = 1
    ...
    #     # Set timing
    #     IlluminateTime = ctypes.c_long(ALP_DEFAULT)
    #     PictureTime = ctypes.c_long(ALP_DEFAULT)
    #     SynchDelay = ctypes.c_long(ALP_DEFAULT)
    #     SynchPulseWidth = ctypes.c_long(ALP_DEFAULT)
    #     TriggerInDelay = ctypes.c_long(ALP_DEFAULT)
    ...
    # def display_black_sequence(self, seq_repeat=ALP_DEFAULT):
    #     '''TODO complete...'''
    #     DeviceId = self.device_id
    #     SequenceId = ctypes.c_ulong(ALP_DEFAULT)
    #     # Allocate sequence
    ...
    # def display_flicker_sequence(self, seq_repeat=ALP_DEFAULT):
    #     '''TODO complete...'''
    #     DeviceId = self.device_id
    #     SequenceId = ctypes.c_ulong(ALP_DEFAULT)
    #     # Allocate sequence
