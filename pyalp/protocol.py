...
class White(Protocol):
    ...
    def project(self, device):
        ...
        # Set up sequence
        device.allocate_sequence_bis(sequence)
        ...
        # Clean sequence
        device.free_sequence_bis(sequence)
        return
...
class Checkerboard(Protocol):
    ...
    def project(self, device):
        ...
        device.allocate_sequence_bis(sequence_1)
        # TODO manage control...
        # device.control(sequence_1)
        # TODO manage timing...
        # device.timing(sequence_1)
        # Setup second sequence
        device.allocate_sequence_bis(sequence_2)
        # TODO manage control...
        ...
        for rep in range(0, self.nb_repetitions):
            ...
            device.free_sequence_bis(sequence_1)
            sequence_1 = alp.sequence.Checkerboard(seed=42)
            device.allocate_sequence_bis(sequence_1)
            # TODO manage timing...
            # device.timing(sequence_1)
            ...
            device.free_sequence_bis(sequence_2)
            sequence_2 = alp.sequence.Checkerboard(seed=None)
            device.allocate_sequence_bis(sequence_2)
            # TODO manage timing...
            # device.timing(sequence_2)
